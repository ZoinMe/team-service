...
func (cr *CommentRepository) GetByID(ctx context.Context, id int64) (*model.Comment, error) {
...
func (cr *CommentRepository) Create(ctx context.Context, comment *model.Comment) (*model.Comment, error) {
...
func (cr *CommentRepository) Update(ctx context.Context, updatedComment *model.Comment) (*model.Comment, error) {
...
func (cr *CommentRepository) Delete(ctx context.Context, id int64) error {
